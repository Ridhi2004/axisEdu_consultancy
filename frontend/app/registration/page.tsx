  ...
  return (
    <div className="bg-slate-50 min-h-screen py-6 lg:py-14">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Success state */}
        {submitState === "success" ? (
          <div className="bg-white rounded-3xl p-10 lg:p-14 border border-slate-200 shadow-sm text-center">
            ...
            <p className="text-slate-500 max-w-md mx-auto">
              Thank you for registering. Our counselors will review your details and get in touch
              with you shortly.
            </p>
            <button
              type="button"
              onClick={() => setSubmitState("idle")}
              className="mt-6 inline-flex items-center gap-2 bg-amber-600 hover:bg-amber-700 text-white font-semibold px-6 py-3 rounded-full transition-colors text-sm"
            >
          ...
          <form
            ...
            className="bg-white rounded-3xl p-6 lg:p-10 border border-slate-200 shadow-sm"
          >
            <div className="grid sm:grid-cols-2 gap-5">
              <Field label="Course / Country Want to Apply" full>
                <input
              ...
              <Field label="Security Check" full>
                <ReCAPTCHA
                  ref={recaptchaRef}
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 flex justify-center">
              <button
                ...
                className="inline-flex items-center gap-2 bg-amber-600 hover:bg-amber-700 disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold px-8 py-3.5 rounded-full transition-colors text-sm shadow-sm hover:shadow-md"
              >
                {submitState === "loading" ? (
                  <>
